...
__version__ = '$Id: 3c76689abc59972508d985103003823f091ba1f4 $'
...
def handle_args(args=None, do_help=True):
    ...
    if config.verbose_output:
        ...
        # replacement with `$Id: 3c76689abc59972508d985103003823f091ba1f4 $`
        # or `$Id: 3c76689abc59972508d985103003823f091ba1f4 $`.
        m = re.search(r"\$Id"
